      ...
      items: {
        ...
        items: {
          ...
          properties: {
            ...
            text: { type: 'string', description: '一句约 20-80 字的中文叙事，不合并多句或整个场景' },
