// public/scripts/homeHotModule.js — ClickUp 16.4 P1.v2 fix (2026-09-07).
//
...
//
// P1.v2 TDZ fix (2026-09-07):
//   The previous PR #23 (ce7f03a) had `const X = X.field` in the
//   `readActiveIdentity` helper, which triggered a Temporal Dead Zone
//   ReferenceError the moment the function was invoked. v2 reads the
//   triple off `window.STORY_OUTSIDE_IDENTITY` directly with explicit
//   destructuring on the INPUT parameter (no closure self-reference),
//   so the function works the instant it is called even when the
//   global is null.
//
// P1.v2 wiring (2026-09-07):
 ...
 *
 * P1.v2 TDZ fix (2026-09-07): do NOT use a `const X = X.field` pattern.
